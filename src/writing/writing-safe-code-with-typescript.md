...
tags:
 - typescript
 - javascript
preview: "I have seen time and time again, 'foo: any = bar;' instead of defining an explicit type for the value. Using 'any' doesn't help in writing safe code and that's the whole point of TypeScript, to write safer code."
---
...
Type inference is a great feature of TypeScript, but its usually best to explictly define types if you know they will be one of the primitive types:
...
If you can't use one of the primitive types, then its time to define some [object types](https://www.typescriptlang.org/docs/handbook/2/objects.html) with an interface, `type` or [generics](https://www.typescriptlang.org/docs/handbook/2/generics.html) to better let TypeScript understand the "allowed" values for a certain variable, function etc.
