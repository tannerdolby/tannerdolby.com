...
<h2 id="what-is-ssh" class="dir-link">What is SSH? {% directlink, "what-is-ssh" %}</h2>
...
<h2 id="what-is-a-shell" class="dir-link">What is a shell? {% directlink "what-is-a-shell" %}</h2>
...
<h2 id="getting-started-overthewire" class="dir-link">Getting started with OverTheWire {% directlink "getting-started-overthewire" %}</h2>
...
<h3 id="connect-bandit-shell" class="dir-link">Connecting to the Bandit Shell {% directlink "connect-bandit-shell" %}</h3>
...
<h2 id="otw-games-begin" class="dir-link">Let the games begin! {% directlink "otw-games-begin" %}</h2>
...
<h3 id="listing-commands" class="dir-link">I've connected to a bandit shell with SSH, now what? {% directlink "listing-commands" %}</h3>
...
<h2 id="bandit-level-zero" class="dir-link">Level Zero &RightArrow; One {% directlink "bandit-level-zero" %}</h2>
...
<h2 id="bandit-level-one" class="dir-link">Level One &RightArrow; Two {% directlink "bandit-level-one" %}</h3>
...
<h3 id="what-is-grep" class="dir-link">What is Grep? {% directlink "what-is-grep" %}</h3>
...
<h2 id="concluding-remarks" class="dir-link">Conclusion {% directlink "concluding-remarks"%}</h2>
