...
Hi there! My name is Tanner Dolby. I'm a Software Engineer and Mathematician based in California. I enjoy working with HTML, CSS, JavaScript, Node, React, Python, Java, and C++. I started programming in 2016 with Swift and learning web development using [freeCodeCamp.org](https://freecodecamp.org) in 2017. Ever since then, I've been hooked on writing code and building things for the web.
